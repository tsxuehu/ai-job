...
| 11 | [运行时与性能](11-运行时与性能.md) | 解释对象内省、动态访问、字节码、GIL 和性能热点 |
...
| 15 | [运行、检查与调试命令](15-编译运行与调试命令.md) | 使用 venv、module 入口、pytest、pdb、profile 和构建工具 |
...
| 7 | 13—15：pyproject、命令、依赖和生产规则 | 案例可安装、测试、调试、启动和部署 |
