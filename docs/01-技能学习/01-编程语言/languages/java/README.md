...
| 11 | [运行时与性能](11-运行时与性能.md) | 解释类加载、反射与代理、JIT、GC 和 profile |
...
| 15 | [编译、运行与调试命令](15-编译运行与调试命令.md) | 使用 JDK、Maven/Gradle、JDWP、JFR 和 JVM 诊断工具 |
...
| 7 | 13—15：feature、Spring、命令和交付 | 整理为可构建服务并做调试与故障演练 |
